...
def bdCreateBlink(side):
    ...
    upLidLocAim = cmds.aimConstraint(upLidDrvChild, upLidLocator, offset=[0, 0, 0], weight=1, aimVector=[1, 0, 0],
                                     upVector=[0, 1, 0], worldUpType="vector", worldUpVector=[0, 1, 0])
    lowLidLocAim = cmds.aimConstraint(lowLidDrvChild, lowLidLocator, offset=[0, 0, 0], weight=1, aimVector=[1, 0, 0],
                                      upVector=[0, 1, 0], worldUpType="vector", worldUpVector=[0, 1, 0])
...
def bdRigEye(side):
    ...
    cmds.aimConstraint(eyeAnim[0], eyeJoint, offset=[0, 0, 0], weight=1, aimVector=[1, 0, 0], upVector=[0, 1, 0],
