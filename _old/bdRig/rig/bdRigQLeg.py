...
def bdRigQLegIk(side):
    ...
    ankleIk = pm.ikHandle(sol='ikRPsolver', sticky='sticky', startJoint=bdGetBone(side, 'thigh', 'ik'),
                          endEffector=bdGetBone(side, 'ankle', 'ik'), name=side + '_ankle_ikHandle')[0]
    footIk = pm.ikHandle(sol='ikSCsolver', sticky='sticky', startJoint=bdGetBone(side, 'ankle', 'ik'),
                         endEffector=bdGetBone(side, 'foot', 'ik'), name=side + '_foot_ikHandle')[0]
    ballIk = pm.ikHandle(sol='ikSCsolver', sticky='sticky', startJoint=bdGetBone(side, 'foot', 'ik'),
                         endEffector=bdGetBone(side, 'toe', 'ik'), name=side + '_ball_ikHandle')[0]
    toeIk = pm.ikHandle(sol='ikSCsolver', sticky='sticky', startJoint=bdGetBone(side, 'toe', 'ik'),
                        endEffector=bdGetBone(side, 'foot', 'ik_end'), name=side + '_toe_ikHandle')[0]
