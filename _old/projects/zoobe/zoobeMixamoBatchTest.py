...
speakAnims = ['speak_jaw_down', 'speak_jaw_up', 'speak_mouth_narrow', 'speak_mouth_wide', 'speak_mouth_open',
              'speak_mouth_shut', 'speak_tongue_in', 'speak_tongue_out']
        ...
        if os.path.isdir(CHARACTERS_PATH):
            ...
            if self.name not in currentCharacters:
                if os.path.isdir(os.path.join(CHARACTERS_PATH, '01_default')):
                    ...
                    shutil.copytree(os.path.join(CHARACTERS_PATH, '01_default'),
                                    os.path.join(CHARACTERS_PATH, self.name))
                else:
