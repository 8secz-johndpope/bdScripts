...
def getProjects():
    projects = []
    excludeDirs = set(['p:\@Recycle', 'p:\___-ProjectName-___EMPTY', 'p:\___-ProjectName-___EMPTY-Copy',
                       'p:\___-ProjectName-___NAMING CONVENTIONS', 'p:\_Export', 'p:\_to_BACKUP', 'p:\ogre_export',
                       'p:\OLD'])
