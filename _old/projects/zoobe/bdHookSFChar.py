...
def bdConnectFingers(namespace):
    tsmFingers = ['LeftThumb_joint1', 'LeftThumb_joint2', 'LeftThumb_joint3', 'LeftFinger1_joint1',
                  'LeftFinger1_joint2', 'LeftFinger1_joint3', 'LeftFinger1_joint4', 'LeftFinger2_joint1',
                  'LeftFinger2_joint2', 'LeftFinger2_joint3', 'LeftFinger2_joint4', 'LeftFinger3_joint1',
                  'LeftFinger3_joint2', 'LeftFinger3_joint3', 'LeftFinger3_joint4', 'LeftFinger4_joint1',
                  'LeftFinger4_joint2', 'LeftFinger4_joint3', 'LeftFinger4_joint4']
    capcomFingers = ['LThumb1', 'LThumb2', 'LThumb3', 'LRH', 'LIndex1', 'LIndex2', 'LIndex3', 'LCH', 'LMiddle1',
                     'LMiddle2', 'LMiddle3', 'LLH', 'LRing1', 'LRing2', 'LRing3', 'LLH', 'LPinky1', 'LPinky2',
                     'LPinky3']
    i = 0
...
def bdConnectArms(namespace):
    ...
    tsmArmChain = ['Arm_joint1', 'Arm_joint2', 'Arm_joint3', 'Arm_joint5', 'Arm_influence7_intermediate_constrain',
                   'Arm_joint6', 'Arm_joint7', 'Arm_joint8', 'Arm_joint7']
...
def bdConnectLegs(namespace):
    sides = {'Left': 'L', 'Right': 'R'}
    tsmLegChain = ['Leg_joint8', 'Leg_joint7', 'Leg_joint4', 'Leg_influence5_intermediate_constrain_halfNode',
                   'Leg_joint1', 'Leg_joint1']
...
def bdRenameLipJoints(namespace):
    ...
    tsmLipJoints = ['upper_lip_right_speak', 'upper_lip_open_center_speak', 'upper_lip_center_speak',
                    'upper_lip_left_speak']
...
def bdRenameForMB():
    capcomJoints = ['Waist', 'LLeg1', 'LLeg2', 'LFoot', 'RLeg1', 'RLeg2', 'RFoot', 'Stomach', 'LArm1', 'LArm2',
                    'LhandRot', 'RArm1', 'RArm2', 'RhandRot', 'LToe', 'RToe', 'LShoulder', 'RShoulder']
    newNames = ['Hips', 'LeftUpLeg', 'LeftLeg', 'LeftFoot', 'RightUpLeg', 'RightLeg', 'RightFoot', 'Spine', 'LeftArm',
                'LeftForeArm', 'LeftHand', 'RightArm', 'RightForeArm', 'RightHand', 'LeftToeBase', 'RightToeBase',
