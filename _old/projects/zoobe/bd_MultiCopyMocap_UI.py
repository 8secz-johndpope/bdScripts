...
def bd_mocapToCotrollers(args):
    ...
    for srcDest in animPairs:
        ...
        spineBones = [('_Spine', 'Spine_Anim'), ('_Spine1', 'Spine1_Anim'), ('_Spine2', 'Spine2_Anim'),
                      ('_Neck', 'Neck_DoNot_Anim'), ('_Head', 'Head_Anim')]
        armBones = [('_L_Clavicle', 'L_Clav_Anim'), ('_L_UpperArm', 'L_Upperarm_Anim'),
                    ('_L_Forearm', 'L_Forearm_Anim'), ('_L_Hand', 'L_Hand_Anim'), ('_L_Finger0', 'L_Fingers_Anim'),
                    ('_R_Clavicle', 'R_Clav_Anim'), ('_R_UpperArm', 'R_Upperarm_Anim'),
                    ('_R_Forearm', 'R_Forearm_Anim'), ('_R_Hand', 'R_Hand_Anim'), ('_R_Finger0', 'R_Fingers_Anim')]
        legBones = [('_L_Foot', 'L_Foot_Anim'), ('_R_Foot', 'R_Foot_Anim'), ('_L_Calf', 'L_Knee_Anim'),
                    ('_R_Calf', 'R_Knee_Anim'), ('_ball', 'Ball_Anim')]
...
def UI():
    ...
    bdBipList = cmds.textScrollList('bipList', numberOfRows=10, allowMultiSelection=True, height=100, sc=bdSelectBip,
                                    p=bdRL)
    bdGenericList = cmds.textScrollList('genericList', numberOfRows=10, allowMultiSelection=True, height=100,
                                        sc=bdSelectGeneric, p=bdRL)
