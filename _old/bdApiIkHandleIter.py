...
def bdMain():
    ...
    if mObj.hasFn(om.MFn.kIkHandle):
        ...
        print 'Rotation axis', math.degrees(rotateOrientationEuler.x), math.degrees(
            rotateOrientationEuler.y), math.degrees(rotateOrientationEuler.z)
        ...
        print 'Local Rotation ', math.degrees(eulerRotation.x), math.degrees(eulerRotation.y), math.degrees(
            eulerRotation.z)
