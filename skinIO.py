...
class MappingDialog(QtGui.QDialog):
    ...
    def setupUI(self):
        ...
        #########
        label = QtGui.QLabel('Unmapped influences')
...
class SkinIOUI(QtGui.QMainWindow):
    def __init__(self, parent=qt_handlers.get_maya_window()):
