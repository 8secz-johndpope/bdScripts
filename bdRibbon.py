...
class bdRibbon(object):
    ...
    def createIk(self):
        ...
        # create the ik
        # self.ikHandle = pm.ikHandle(sj = self.ikJntList[0], ee = self.ikJntList[-1], c=self.ikCrv, ccv=False, sol='ikSplineSolver',name = self.name + '_ikspline')[0]
        pm.select(cl=1)
