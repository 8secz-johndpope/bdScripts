...
def initialize():
    ...
    sePushPullConstraint.constraintParentAttr = matrixAttr.create("constraintParentMatrix", "cpm",
                                                                  OpenMaya.MFnNumericData.kDouble)
    matrixAttr.setStorable(False)
    sePushPullConstraint.addAttribute(sePushPullConstraint.constraintParentAttr)
    sePushPullConstraint.attributeAffects(sePushPullConstraint.constraintParentAttr,
    ...
    lastPositionAttr = nAttr.create("lastPosition", "lp", sePushPullConstraint.lpAttrX, sePushPullConstraint.lpAttrY,
                                    sePushPullConstraint.lpAttrZ)
