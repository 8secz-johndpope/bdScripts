...
def initialize():
    ...
    trNode.aInTranslation = nAttr.create('inTranslation', 'intr', trNode.aInTranslationX, trNode.aInTranslationY,
                                         trNode.aInTranslationZ)
    nAttr.setStorable(1)
    nAttr.setKeyable(1)
    nAttr.setWritable(1)
    ...
    trNode.aOutTranslation = nAttr.create('outTranslation', 'outt', trNode.aOutTranslationX, trNode.aOutTranslationY,
                                          trNode.aOutTranslationZ)
    nAttr.setStorable(0)
    nAttr.setKeyable(0)
    nAttr.setWritable(0)
