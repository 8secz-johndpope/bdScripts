...
def initialize():
    ...
    varfkNode.aInRotation = nAttr.create('inRotation', 'inr', varfkNode.aInRotationX, varfkNode.aInRotationY,
                                         varfkNode.aInRotationZ)
    nAttr.setStorable(1)
    nAttr.setKeyable(1)
    nAttr.setWritable(1)
    ...
    varfkNode.aOutRotation = nAttr.create('outRotation', 'outr', varfkNode.aOutRotationX, varfkNode.aOutRotationY,
                                          varfkNode.aOutRotationZ)
    nAttr.setStorable(0)
    nAttr.setKeyable(0)
    nAttr.setWritable(0)
